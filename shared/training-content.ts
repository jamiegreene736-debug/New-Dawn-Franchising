...
export const TRAINING_TRACKS: TrainingTrack[] = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          { id: "1.3.1", title: "Overview of Every Tool You Will Use", content: "As an NDF franchisee, you have access to:\n\n• Franchisee Training Portal (this portal) — your learning hub\n• Franchisee Marketing Portal — your lead pipeline and outreach tools\n• Property Management Platform — for managing properties and tenants\n• CRM — for managing homeowner client relationships\n• Operational Dashboards — for monitoring your business KPIs" },
          { id: "1.3.2", title: "How to Log Into the Franchisee Marketing Portal", content: "Your Marketing Portal is accessible from the navigation menu under Portals → Franchisee Marketing Portal.\n\nYou use the same login credentials as this Training Portal. The Marketing Portal unlocks automatically once you've completed the Launch Checklist and Track 1 training.\n\nIn the Marketing Portal you'll find your homeowner lead pipeline, your daily outreach brief for approval, and your analytics dashboard." },
        ...
        quiz: [
          { id: "q1", question: "When does the Marketing Portal unlock?", options: ["Immediately after registration", "After completing the Launch Checklist and Track 1 training", "After 30 days", "Only when Dylan manually enables it"], correctIndex: 1 },
          ...
          { id: "q5", question: "What does the Franchisee Marketing Portal help you do?", options: ["Manage your personal social media", "Find and reach out to homeowner leads in your territory", "Apply for your E-2 visa", "Hire staff"], correctIndex: 1 },
        ],
        passMark: 80,
      },
    ],
